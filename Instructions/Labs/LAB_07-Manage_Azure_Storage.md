...
1. Select your uploaded file and then to the ellipsis (...) on the far right, select **Generate SAS**. Specify the following settings (leave others with their default values):
