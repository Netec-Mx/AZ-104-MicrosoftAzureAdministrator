...
1. Select **Custom autoscale**. Then change the **Scale mode** to **Scale based on metric**. And then select **Add a rule**, and then select **Add** when you complete the configuration.
